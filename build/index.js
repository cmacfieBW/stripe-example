    ...
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    searchRes = _a.sent();
                    console.log("metadata['firebaseId']:'" + firebaseId + "'");
                    console.log(searchRes);
                    searchRes.data.map(function (d) {
                        console.log(d.metadata);
                    });
                    if (searchRes && searchRes.data && searchRes.data.length > 0) {
                        console.log("return existing customer");
...
app.post('/create-checkout-session-card-subscription', function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var _a, priceId, email, secret_key, stripe, session;
    return __generator(this, function (_b) {
        switch (_b.label) {
            case 0:
...
app.post('/create-checkout-session-card', function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var _a, amount, name, image, email, secret_key, stripe, session;
    return __generator(this, function (_b) {
        switch (_b.label) {
            case 0:
                console.log("Called /create-checkout-session");
                _a = req.body, amount = _a.amount, name = _a.name, image = _a.image, email = _a.email;
                secret_key = getKeys().secret_key;
                stripe = new stripe_1.default(secret_key, {
                    apiVersion: '2022-08-01',
                    typescript: true,
